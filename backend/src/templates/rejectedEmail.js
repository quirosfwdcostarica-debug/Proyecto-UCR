/**
 * Genera el contenido HTML y el Asunto para el correo de solicitud RECHAZADA.
 * 
 * @param {string} nombre - Nombre del usuario
 * @param {string} fecha - Fecha de la actualización
 * @returns {Object} Objeto con el 'subject' y 'html'
 */
const getRejectedEmailTemplate = (nombre, fecha) => {
  const subject = 'Tu solicitud ha sido RECHAZADA — Sistema de Exalumnos UCR';
  
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: auto; color: #333; line-height: 1.6;">
      <p>Hola, <strong>${nombre}</strong>.</p>
      
      <p>Tu solicitud ha sido <strong style="color: #c62828;">RECHAZADA</strong>.</p>

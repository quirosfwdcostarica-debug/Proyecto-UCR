          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {estudiantes.map((student) => (
                <Card
                  key={student.id}
                  className="p-6 border-border shadow-sm bg-white flex flex-col h-full hover:shadow-md transition-shadow"
                >
                  <div className="flex gap-4 mb-5">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-sm font-semibold text-[#0f4c81] mt-0.5 truncate">
                        {student.carrera}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {student.apoyoBuscado.map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-1 bg-[#dcfce7] text-[#166534] rounded text-[10px] font-bold tracking-wide"
                      >
                        {tag}
                      </span>
                    ))}

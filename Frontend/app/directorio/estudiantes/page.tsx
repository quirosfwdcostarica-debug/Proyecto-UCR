...
export default function DirectorioEstudiantes() {
  ...
  return (
    <div className="min-h-full bg-ucr-gris-fondo dark:bg-ucr-negro">
      <TopBar title="Directorio" />

      <div className="p-8 max-w-7xl mx-auto space-y-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-ucr-celeste-medium dark:text-ucr-celeste mb-2 font-display uppercase">
        ...
        <div className="flex gap-4 mb-2">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 h-12 bg-white dark:bg-slate-950 border-slate-200 dark:border-slate-800 shadow-sm text-base"
            />
          </div>
          <Button
        ...
        {/* Filtros expandibles */}
        {showFilters && (
          <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full h-9 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 rounded text-sm text-slate-700 dark:text-slate-300 px-2 outline-none focus:border-ucr-celeste-medium"
              >
                ...
                >
                  ...
                  <div className="flex gap-4 mb-5">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-sm font-semibold text-ucr-celeste-medium dark:text-ucr-celeste mt-0.5 truncate">
                        {student.carrera}
                      </p>
                    </div>
                  </div>
                  ...
                  {student.areaProyecto && (
                    <div className="bg-ucr-celeste-medium/10 dark:bg-ucr-celeste-medium/10 p-3 rounded-md mb-5 border-l-2 border-ucr-celeste-medium">
                      <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1 uppercase tracking-wider">
                        Área del Proyecto
                      </p>
                      <p className="text-sm font-medium text-slate-850 dark:text-slate-300 leading-snug">
                        {student.areaProyecto}
                      </p>
                    </div>
                  )}
                  ...
                  <div className="mb-4 mt-auto">
                    <div className="flex justify-between text-xs font-semibold mb-1.5">
                      ...
                      <span className="text-ucr-naranja font-bold">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {student.apoyoBuscado.map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-1 bg-ucr-celeste-tint dark:bg-ucr-celeste/20 text-ucr-celeste-medium dark:text-ucr-celeste rounded text-[10px] font-bold tracking-wide uppercase"
                      >
                        {tag}
                      </span>
                    ))}
